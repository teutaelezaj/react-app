...
export default function DatingTipsScreen() {
  const [inputText, setInputText] = useState("Hey Nexus! I have been having some silly arguments with my significant other. How can we navigate this?");
