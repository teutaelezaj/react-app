...
export default function InterviewScreen() {
  const [inputText, setInputText] = useState("I have a job interview coming up next week. It will be virtual, and for a software engineering positon. This is the first round, so it will mostly consist of behavioral questions. What are some potential questions that can be asked?");
